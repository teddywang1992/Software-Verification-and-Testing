...
public class SocialNetwork implements ISocialNetwork {
	...
	public void rejectAllFriendships() throws NoUserLoggedInException {
		if (currentUser == null) throw new NoUserLoggedInException();
		// must clone pendingResponses to avoid concurrentModificationException
	...
	public void acceptAllFriendships() throws NoUserLoggedInException {
		if (currentUser == null) throw new NoUserLoggedInException();
		// must clone pendingResponses to avoid concurrentModificationException
		Collection<String> pendingResponses = new HashSet<String>();
		for (String each : currentUser.getIncomingRequests()) {
			pendingResponses.add(new String(each));
		}
		for (String each : pendingResponses) {
	...
	public Collection<String> recommendFriends() throws NoUserLoggedInException, UserNotFoundException {
		if (currentUser == null) throw new NoUserLoggedInException();
		Collection<String> recommendations = new HashSet<String>();
